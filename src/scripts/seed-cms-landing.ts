...
async function seed() {
  const typeIds: ContentTypeIds = {
    ...
    HTML: await getContentTypeId('HTML'),
    IMAGE: await getContentTypeId('IMAGE'),
    BANNER: await getContentTypeId('BANNER'),
    VIDEO: await getContentTypeId('VIDEO'),
  };
